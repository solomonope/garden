    ...
    build: baseBuildSpecSchema()
      .keys({
        ...
        buildInDocker: joi
          ...
          .default(false)
          .description(
            "Build the image in a local Docker daemon. This may be more efficient if the image will be run from a local Docker daemon, e.g. in a local Kubernetes cluster."
          ),
        tarOnly: joi
          .boolean()
          .default(false)
